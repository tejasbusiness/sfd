...
function AboutPage() {
  return (
    <PublicLayout>
      <PageHeader eyebrow="About" title="A specialist, not a generalist." variant="clinical" />
      <div className="mx-auto max-w-2xl px-4 pb-20 pt-4 sm:px-6">
        <Reveal>
          <p className="text-lg leading-relaxed text-studio-ink-soft">
        ...
        <Reveal delay={0.1}>
          <p className="mt-5 text-lg leading-relaxed text-studio-ink-soft">
