...
- `npm run build:production` (cleans `dist/` first; leaves out `internal-diagnostic` pages such as `/build-check/`) passes (the `og-default.jpg` blocker was resolved 2026-09-21).
